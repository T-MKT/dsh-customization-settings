...
- **Wallpaper**: image (upload / URL / built-in), placement (fullscreen / conversation), mask opacity (color adapts to the theme) and a custom sidebar mask (color and opacity);
